...
enum class ThemeId(
    ...
    FOREST("Forest", "Peaceful forest scene", 10),
    GALAXY("Galaxy", "Deep space adventure", 20),
    OCEAN("Ocean", "Underwater treasure hunt", 30),
    NEON_CITY("Neon City", "Cyberpunk cityscape", 40)
}
...
data class GameTheme(
    ...
    companion object {
        ...
        fun fromId(id: ThemeId): GameTheme = when (id) {
